...
- [ ] Explain what a token is used for.
  token is used to make security decisions and to store tamper-proof information about some system entity.
- [ ] What steps can you take in your web apps to keep your data secure?
    Using tokens and saving any data in env files
- [ ] Describe how web servers work.
  Clients/Browsers request data from server and wait for a response to come back which is what is displayed
